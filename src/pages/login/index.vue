  ...
  loginFormRef.value?.validate(async (valid) => {
    if (valid) {
      ...
      try {
        ...
        // 网络错误已在 axios 拦截器中统一处理，这里不再重复提示
        if (errorMsg === "网络有点开小差" || errorMsg === "Network Error") {
          createCode()
          return
        }
    ...
    <div class="login-card">
      ...
      <el-form ref="loginFormRef" :model="loginFormData" :rules="loginFormRules" @keyup.enter="handleLogin">
        <el-form-item prop="username">
          <el-input
            v-model.trim="loginFormData.username" placeholder="邮箱" type="text" tabindex="1" prefix-icon="User"
            size="large"
          />
        </el-form-item>
